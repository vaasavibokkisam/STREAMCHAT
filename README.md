...
```bash
git clone https://github.com/vaasavibokkisam/STREAMCHAT.git
cd STREAMCHAT
```
...
| Protocol | Plain HTTP | Upgrade handshake required |
| Proxy support | Works out of the box | Needs extra config |
